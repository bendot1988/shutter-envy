...
export const primaryNav: NavItem[] = [
    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: 'Faux Wood Shutters', href: '/faux-wood-shutters/', description: 'Moisture-resistant & hard-wearing' },
          { label: 'Arched Window Shutters', href: '/arched-window-shutters/', description: 'Made-to-measure for shaped windows' },
          { label: 'Aluminium Plantation Shutters', href: '/aluminium-plantation-shutters/', description: 'Security, heat & moisture resistant' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Derby',              sublabel: 'Shutters in Derby',              href: '/locations/shutters-derby/',                 image: '/wp-content/uploads/2024/10/Derby_-_Junction_of_The_Strand__Wardwick_geograph_6937231.jpg' },
      { label: 'Derbyshire',         sublabel: 'Shutters in Derbyshire',         href: '/locations/shutters-derbyshire/',            image: '/wp-content/uploads/2026/04/Bay-window-shutters-in-Loughborough.jpeg' },
    ],
  },
...
export const footerNav = {
  ...
  shutters: [
    ...
    { label: 'Faux Wood Shutters', href: '/faux-wood-shutters/' },
    { label: 'Arched Window Shutters', href: '/arched-window-shutters/' },
    { label: 'Aluminium Plantation Shutters', href: '/aluminium-plantation-shutters/' },
