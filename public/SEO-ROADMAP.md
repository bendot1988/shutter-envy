...
- **Last updated:** 2026-06-16 (post 4 A8)
...
- [ ] **A8 — Editorial cadence: 1 post per fortnight (6 topics seeded).** status: in-progress · owner: Claude · done: — · note: 4 of 6 shipped (ahead of cadence). Post 1 (2026-06-04): `/shutter-blinds-explained-uk-guide/` targets A.23 `shutter blinds` (481 impr / pos 29 / 0% CTR). Post 2 (2026-06-09): `/are-mdf-shutters-any-good-honest-uk-verdict/` targets A.7 `mdf shutters` (968 impr / pos 48.49 / 0% CTR). Post 3 (2026-06-09, shipped by team in parallel): `/best-blackout-blind-for-bifold-doors-leicestershire/` targets A.21 `motorised blinds for bifold doors` cluster (503 impr / pos 24). Post 4 (2026-06-16): `/are-aluminium-shutters-worth-it-uk-buyers-guide/` targets A.25 `aluminium shutters` (471 impr / pos 19.74) — completes the "honest verdict" trilogy (MDF / faux wood / aluminium) and feeds the Portchester product hub without cannibalising. 2 seeded topics still pending (noise-reducing shutters guide, cottage window shutters — the latter likely to be withdrawn for the same specialist-promise reason as sash windows).
